...
Version  : 4.8.15
Release  : 32
URL      : https://github.com/Z3Prover/z3/archive/z3-4.8.15/z3-4.8.15.tar.gz
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.8.15/z3-4.8.15.tar.gz
...
%prep
%setup -q -n z3-z3-4.8.15
cd %{_builddir}/z3-z3-4.8.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647900406
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/z3-z3-4.8.15/LICENSE.txt %{buildroot}/usr/share/package-licenses/Z3/dad4e766bd1dda39916ad6d99a48f02c6884438a
pushd clr-build32
%make_install32

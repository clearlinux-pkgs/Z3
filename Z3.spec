...
Version  : 4.12.1
Release  : 34
URL      : https://github.com/Z3Prover/z3/archive/z3-4.12.1/z3-4.12.1.tar.gz
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.12.1/z3-4.12.1.tar.gz
...
%prep
%setup -q -n z3-z3-4.12.1
cd %{_builddir}/z3-z3-4.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679693391
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libz3.so.4.12.1.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libz3.so.4.12
/usr/lib32/libz3.so.4.12.1.0

...
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.14.0/z3-4.14.0.tar.gz
...
%prep
%setup -q -n z3-z3-4.14.0
cd %{_builddir}/z3-z3-4.14.0
pushd ..
cp -a z3-z3-4.14.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739986647
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libz3.so.4.14.0.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libz3.so.4.14
/usr/lib32/libz3.so.4.14.0.0

...
Version  : 4.13.4
Release  : 41
URL      : https://github.com/Z3Prover/z3/archive/z3-4.13.4/z3-4.13.4.tar.gz
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.13.4/z3-4.13.4.tar.gz
...
%prep
%setup -q -n z3-z3-4.13.4
cd %{_builddir}/z3-z3-4.13.4
pushd ..
cp -a z3-z3-4.13.4 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735121457
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libz3.so.4.13.4.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libz3.so.4.13
/usr/lib32/libz3.so.4.13.4.0

...
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.14.1/z3-4.14.1.tar.gz
...
%prep
%setup -q -n z3-z3-4.14.1
cd %{_builddir}/z3-z3-4.14.1
pushd ..
cp -a z3-z3-4.14.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741768001
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libz3.so.4.14
/usr/lib64/libz3.so.4.14.1.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libz3.so.4.14
/usr/lib32/libz3.so.4.14.1.0
